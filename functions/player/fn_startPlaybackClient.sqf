...
[{
    ...
    if (
        ...
        diag_log format ["playbackpos: %1, count: %2, count target: %3", grad_replay_playbackPosition, count (GRAD_REPLAY_DATABASE_LOCAL), GRAD_REPLAY_DATABASE_TARGET_COUNT_LOCAL];
